...
public interface CertificateService {
     ...
     */
    List<Certificate> findAll(SortRequest sortRequest, FilterRequest filterRequest) throws ServiceException;
     ...
     */
    Certificate create(Certificate certificate) throws ServiceException;
     ...
     */
    Certificate selectiveUpdate(Certificate certificate) throws EntityNotFoundException, ServiceException;
