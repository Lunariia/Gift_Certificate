...
public interface TagService {
     ...
     * @throws DaoException when tag id specified, or tag invalid
     */
     ...
     * @throws DaoException when one of tags invalid
     */
    Set<Tag> createIfNotExist(Set<Tag> tags) throws DaoException;
