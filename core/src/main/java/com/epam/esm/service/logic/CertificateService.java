...
public interface CertificateService {
     ...
     */
    Certificate findById(Long id) throws EntityNotFoundException;
     ...
     * @throws DaoException            when sortRequest is not valid for Certificate entity
     * @throws EntityNotFoundException if found noting
     */
    List<Certificate> findAll(SortRequest sortRequest, FilterRequest filterRequest) throws DaoException;
     ...
     * @throws DaoException         when certificate id specified, or certificate invalid
     */
    Certificate create(Certificate certificate) throws DaoException;
     ...
     * @throws NullPointerException    when certificate parameter is null
     * @throws DaoException            when certificate id not specified
     * @throws EntityNotFoundException when updating certificate does not exists, or resulting certificate is vot valid
     */
    Certificate selectiveUpdate(Certificate certificate) throws EntityNotFoundException, DaoException;
     ...
     */
    Certificate deleteById(Long id) throws EntityNotFoundException;
}
